...
$_lang['fred.permissions.fred_element_category_save'] = 'Create/edit/duplicate Element (mgr)';
...
$_lang['fred.permissions.fred_themed_templates'] = 'View Theme/Template assignments (mgr)';
$_lang['fred.permissions.fred_settings'] = 'View the Settings menu in the sidebar (web)';
...
$_lang['fred.permissions.fred_blueprints_create_public'] = 'Create public Blueprints (mgr) (web)';
$_lang['fred.permissions.fred_blueprint_categories'] = 'View Blueprint Categories (mgr)';
$_lang['fred.permissions.fred_blueprint_categories_save'] = 'Create/edit/duplicate Blueprint Categories (mgr) (web)';
$_lang['fred.permissions.fred_blueprint_categories_delete'] = 'Delete Blueprint Categories (mgr)';
$_lang['fred.permissions.fred_blueprint_categories_create_public'] = 'Create Public Blueprint Categories (mgr) (web)';
$_lang['fred.permissions.new_document_in_root'] = 'Create Resources in the top-level of web root (mgr) (web)';
$_lang['fred.permissions.view_unpublished'] = 'View unpublished Resources (web)';
$_lang['fred.permissions.resource_duplicate'] = 'Duplicate Resources (mgr) (web)';
$_lang['fred.permissions.unpublish_document'] = 'Unpublish Resources (mgr) (web)';
$_lang['fred.permissions.publish_document'] = 'Publish Resources (mgr) (web)';
$_lang['fred.permissions.save_document'] = 'Save Resources (mgr) (web)';
$_lang['fred.permissions.new_document'] = 'Create new Resources (mgr) (web)';
$_lang['fred.permissions.delete_document'] = 'Delete Resources (mgr) (web)';
$_lang['fred.permissions.undelete_document'] = 'Undelete Resources (mgr) (web)';
