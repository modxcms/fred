...
$_lang['fred.home.rte_configs'] = 'RTE настройки';
$_lang['fred.home.blueprints'] = 'Макеты';
...
$_lang['fred.home.media_sources'] = 'Медиа источники';

$_lang['fred.blueprints.none'] = 'Макеты не найдено.';
$_lang['fred.blueprints.name'] = 'Имя';
$_lang['fred.blueprints.description'] = 'Описание';
$_lang['fred.blueprints.complete'] = 'Выполнено';
$_lang['fred.blueprints.public'] = 'Публичный';
...
$_lang['fred.blueprint_categories.public'] = 'Публичный';
...
$_lang['fred.elements.name'] = 'Имя';
$_lang['fred.elements.description'] = 'Описание';
$_lang['fred.elements.category'] = 'Категория';
$_lang['fred.elements.rank'] = 'Ранк';
$_lang['fred.elements.search_name'] = 'Поиск по имени';
$_lang['fred.elements.remove'] = 'Удалить элемент';
$_lang['fred.elements.remove_confirm'] = 'Вы уверены, что хотите удалить [[+name]] элемент?';
$_lang['fred.elements.quick_update'] = 'Быстрое обновление элемента';
$_lang['fred.elements.update'] = 'Обновить элемент';
$_lang['fred.elements.create'] = 'Создать элемент';
$_lang['fred.elements.markup'] = 'Разметка элемента(ов)';
$_lang['fred.elements.options'] = 'Опции';
$_lang['fred.elements.options_override'] = 'Переопределение параметров';
$_lang['fred.elements.option_set'] = 'Набор параметров';
$_lang['fred.elements.duplicate'] = 'Дублировать элемент';
...
$_lang['fred.element_categories.number_of_elements'] = '# Элементы';
$_lang['fred.element_categories.rank'] = 'Ранк';
$_lang['fred.element_categories.search_name'] = 'Поиск по имени';
...
$_lang['fred.element_categories.templates'] = 'Шаблоны';

$_lang['fred.element_option_sets.none'] = 'Наборы параметров не найдены.';
$_lang['fred.element_option_sets.name'] = 'Имя';
$_lang['fred.element_option_sets.description'] = 'Описание';
$_lang['fred.element_option_sets.complete'] = 'Выполнено';
$_lang['fred.element_option_sets.search_name'] = 'Поиск по имени';
$_lang['fred.element_option_sets.create'] = 'Создать набор параметров';
$_lang['fred.element_option_sets.update'] = 'Обновить набор параметров';
$_lang['fred.element_option_sets.remove'] = 'Удалить набор параметров';
$_lang['fred.element_option_sets.remove_confirm'] = 'Вы уверены, что хотите удалить [[+name]] набор параметров?';
$_lang['fred.element_option_sets.quick_update'] = 'Быстрое обновление набора параметров';
$_lang['fred.element_option_sets.data'] = 'Дата';
$_lang['fred.element_option_sets.no_set'] = 'Нет';
$_lang['fred.element_option_sets.duplicate'] = 'Дублировать набор параметров';
$_lang['fred.element_option_sets.new_name'] = 'Новое имя';
$_lang['fred.element_option_sets.preview'] = 'Просмотр набора параметров';
$_lang['fred.element_option_sets.theme'] = 'Тема';
$_lang['fred.element_option_sets.new_from_override'] = 'Создать набор параметров из переопределения';

$_lang['fred.element_rte_configs.none'] = 'Настройки RTE не найдены.';
$_lang['fred.element_rte_configs.name'] = 'Имя';
$_lang['fred.element_rte_configs.description'] = 'Описание';
$_lang['fred.element_rte_configs.search_name'] = 'Поиск по имени';
$_lang['fred.element_rte_configs.create'] = 'Создать RTE настройки';
$_lang['fred.element_rte_configs.update'] = 'Обновить RTE настройки';
$_lang['fred.element_rte_configs.remove'] = 'Удалить RTE настройки';
$_lang['fred.element_rte_configs.remove_confirm'] = 'Вы уверены, что хотите удалить [[[+name]] RTE настройки?';
$_lang['fred.element_rte_configs.quick_update'] = 'Быстрое обновление RTE настроек';
$_lang['fred.element_rte_configs.data'] = 'Дата';
$_lang['fred.element_rte_configs.duplicate'] = 'Дублировать RTE настройки';
$_lang['fred.element_rte_configs.new_name'] = 'Новое имя';
$_lang['fred.element_rte_configs.theme'] = 'Тема';

$_lang['fred.themes.none'] = 'Темы не найдены.';
$_lang['fred.themes.name'] = 'Имя';
$_lang['fred.themes.description'] = 'Описание';
$_lang['fred.themes.create'] = 'Создать тему';
$_lang['fred.themes.update'] = 'Обновить тему';
$_lang['fred.themes.remove'] = 'Удалить тему';
$_lang['fred.themes.remove_confirm'] = 'Вы уверены, что хотите удалить тему "[[+name]]"?';
$_lang['fred.themes.search_name'] = 'Поиск по имени';
$_lang['fred.themes.new_name'] = 'Новое имя';
$_lang['fred.themes.duplicate'] = 'Дублировать тему';
$_lang['fred.themes.all'] = 'Все темы';
$_lang['fred.themes.version'] = 'Версия';
$_lang['fred.themes.build'] = 'Построить тему';
$_lang['fred.themes.release'] = 'Релиз';
$_lang['fred.themes.general'] = 'Главное';
$_lang['fred.themes.categories'] = 'Включенные категории элементов для необходимых снипетов, чанков и плагинов';
$_lang['fred.themes.add_dependency'] = 'Добавить расширение';
...
$_lang['fred.themes.license'] = 'Лицензия';
$_lang['fred.themes.readme'] = 'Read Me';
$_lang['fred.themes.dependencies'] = 'Расширения';
$_lang['fred.themes.docs'] = 'Документы';
$_lang['fred.themes.latest_build'] = 'Последняя сборка';
$_lang['fred.themes.download'] = 'Скачать тему';
$_lang['fred.themes.theme_folder'] = 'Папка Темы';
$_lang['fred.themes.theme_dir_msg_title'] = 'Каталог темы создан';
...
$_lang['fred.themes.included_theme_folder'] = 'Каталог ресурсов для этой темы';
...
$_lang['fred.themes.theme_build_changelog_desc'] = 'Список всех новых функций и исправлений с момента первого релиза.';
...
$_lang['fred.themes.delete_theme_folder'] = 'Удалить каталог темы';
$_lang['fred.themes.duplicate_theme_folder'] = 'Дублировать каталог темы';
$_lang['fred.themes.duplicate_theme_objects'] = 'Дублировать объекты темы (Элементы, Макеты и тд)';
$_lang['fred.themes.build_and_download'] = 'Собрать и скачать Тему';
...
$_lang['fred.themes.settings_prefix'] = 'Префикс настроек';
$_lang['fred.themes.resolvers'] = 'Резолверы';
$_lang['fred.themes.resolver'] = 'Резолвер';
$_lang['fred.themes.add_resolver'] = 'Добавить резолвер';
$_lang['fred.themes.theme_build_resolvers_desc'] = 'Список пользовательских резолверов PHP, которые будут добавлены в тему.';
...
$_lang['fred.themes.extract_tpl'] = 'Извлечь шаблон';
...
$_lang['fred.media_sources.update'] = 'Обновить Медиа-источник';
$_lang['fred.media_sources.fred'] = 'Включено для Fred';
$_lang['fred.media_sources.fred_read_only'] = 'Только чтение для Fred';
$_lang['fred.media_sources.search'] = 'Поиск';
$_lang['fred.media_sources.none'] = 'Медиа-источники не были найдены.';
$_lang['fred.media_sources.go_to'] = 'Управление Медиа-источниками';

$_lang['fred.tvs.dropzone.hide_input'] = 'Скрыть поле от менеджера';
...
$_lang['setting_fred.element_sort'] = 'Сортировка Элементов';
$_lang['setting_fred.element_sort_desc'] = 'Сортировка элементов по имени или рангу';
...
$_lang['setting_fred.image_editor_desc'] = 'Редактор для изображений';
$_lang['setting_fred.rte'] = 'Текстовый редактор';
...
$_lang['setting_fred.logout_url'] = 'Ссылка Выхода';
...
$_lang['fred.err.blueprints_ns_category'] = 'Категория обязательна';
$_lang['fred.err.bad_sort_column'] = 'Сортировка сетки по <strong>[[+column]]</strong> для использования drag & drop сортировки.';
$_lang['fred.err.clear_filter'] = 'Очистите фильтры, чтобы использовать сортировку перетаскиванием.';
$_lang['fred.err.required_filter'] = 'Вы имеете фильтр по [[+filter]].';
$_lang['fred.err.element_categories_ns_name'] = 'Имя обязательно';
$_lang['fred.err.element_categories_ns_theme'] = 'Тема обязательна';
$_lang['fred.err.elements_ns_name'] = 'Имя обязательно';
$_lang['fred.err.elements_ns_category'] = 'Категория обязательна';
$_lang['fred.err.element_settings_ns_name'] = 'Имя обязательно';
$_lang['fred.err.element_settings_ae_name'] = 'Элемент с таким именем уже существует.';
$_lang['fred.err.element_option_sets_ns_name'] = 'Имя обязательно';
$_lang['fred.err.element_option_sets_ns_theme'] = 'Тема обязательна';
$_lang['fred.err.element_option_sets_invalid_json_title'] = 'Набор параметров JSON недействителен';
$_lang['fred.err.element_override_invalid_json_title'] = 'Переопределение параметров JSON недопустимо';
$_lang['fred.err.element_rte_config_invalid_json_title'] = 'RTE настройки JSON недействительны';
$_lang['fred.err.invalid_json'] = '[[+error]] возле строки [[+row]] и столбца [[+column]].';
$_lang['fred.err.element_option_sets_ae_name'] = 'Набор параметров с таким именем уже существует в теме.';
$_lang['fred.err.element_rte_configs_ns_name'] = 'Имя обязательно';
$_lang['fred.err.element_rte_configs_ns_theme'] = 'Тема обязательна';
$_lang['fred.err.element_rte_configs_ae_name'] = 'RTE настройки с таким именем уже существуют в теме.';
$_lang['fred.err.theme_ns_name'] = 'Имя обязательно';
$_lang['fred.err.blueprint_categories_ns_theme'] = 'Тема обязательна';
$_lang['fred.err.themed_templates_ns_template'] = 'Шаблон обязателен';
$_lang['fred.err.themed_templates_ns_theme'] = 'Тема обязательна';
$_lang['fred.err.themed_templates_ae_template'] = 'Тема уже назначена для этого шаблона';
$_lang['fred.err.fred_dependency_title'] = 'Требуется Зависимость';
...
$_lang['fred.err.theme_name_invalid_format'] = 'Допускаются только буквы, цифры и знак подчеркивания "_".';
$_lang['fred.err.theme_docs_changelog_ns'] = 'Список изменений обязателен';
$_lang['fred.err.theme_docs_readme_ns'] = 'Read Me обязателен';
$_lang['fred.err.theme_docs_license_ns'] = 'Лицензия обязательна';
$_lang['fred.err.theme_no_built_file'] = 'Транспортный пакет не найден.';
$_lang['fred.err.theme_read_file'] = 'Транспортный пакет не читается.';
$_lang['fred.err.themes_version_number_format'] = 'Пожалуйста, укажите номер версии в формате X.Y.Z';
$_lang['fred.err.themes_release_format'] = 'Неверный выпуск. Допускается только pl, альфа или бета с дополнительным индексом. Примеры: pl; alpha3, beta5';
$_lang['fred.err.blueprint_categories_ae_name'] = 'Категория макета с таким именем уже существует.';
$_lang['fred.err.blueprints_ae_name'] = 'Проект с таким именем уже существует.';
...
$_lang['fred.err.themes_extract_tpl_parse_error'] = 'Извлечение шаблона не является действительным JSON.';
