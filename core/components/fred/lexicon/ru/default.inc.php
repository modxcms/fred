...
$_lang['setting_fred.template_ids'] = '*DEPRECATED* Template IDs';
$_lang['setting_fred.template_ids_desc'] = '*DEPRECATED* Comma separated list of template IDs where Fred will init.';
...
$_lang['setting_fred.generated_images_path'] = 'Путь к сгенерированным изображениям';
$_lang['setting_fred.generated_images_path_desc'] = 'Физический путь к каталогу, в котором будут храниться сгенерированные изображения (макеты и скриншоты элементов).';
$_lang['setting_fred.generated_images_url'] = 'URL сгенерированных изображений';
$_lang['setting_fred.generated_images_url_desc'] = 'URL путь каталога для созданных изображений.';
