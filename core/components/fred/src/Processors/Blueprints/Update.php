...
class Update extends UpdateProcessor
{
    ...
    public function afterSave()
    {
        ...
        $this->modx->removeCollection(FredBlueprintTemplateAccess::class, ['blueprint' => $this->object->id]);

        foreach ($templates as $template) {
            $categoryTemplate = $this->modx->newObject(FredBlueprintTemplateAccess::class);
