...
class Update extends UpdateProcessor
{
    ...
    public function afterSave()
    {
        ...
        $this->modx->removeCollection(FredElementCategoryTemplateAccess::class, ['category' => $this->object->id]);

        foreach ($templates as $template) {
            $categoryTemplate = $this->modx->newObject(FredElementCategoryTemplateAccess::class);
