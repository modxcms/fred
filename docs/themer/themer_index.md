...
Advanced Fred themers will need to know Javascript to advanced elements with [JS Events](themer/elements/js_events.md).
...
![Ace Integration](img/ace_integration_dialog.png)
