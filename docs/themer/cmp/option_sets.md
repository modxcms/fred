...
[Option Sets](themer/options/options_index.md) allow you to create common configurations and frequently used sub-configs (e.g., color swatch pickers or a list of fonts) for use across multiple Elements.
...
- **Data** - JSON with [Element options](themer/options/options_index.md)
