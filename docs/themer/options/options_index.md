...
Option Sets with the `complete` flag set to `Yes` can be assigned to individual [Element](themer/elements/elements_index.md). Option Sets can also be assigned to more than one Element, making it easier to reuse common settings across Elements.
