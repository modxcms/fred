...
When converting existing pages to Fred, you will want to specify a _Default Element_ in the Themes grid, [see documentation](themer/cmp/cmp_themes.md). Without a default element set, your content will disappear when switching a resource to Fred.
