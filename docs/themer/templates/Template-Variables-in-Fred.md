...
![tv_properties.png](img/tv_properties.png)
...
TVs can have all the types that Fred Options have. You can find more information on the different types in the [Fred Options documentation](themer/options/settings.md#available-settings-types).
