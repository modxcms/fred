...
.fred .fred--sidebar_page_settings:before {
    background: url(data:image/svg + xml, %3Csvgxmlns="http://www.w3.org/2000/svg"viewBox="0 0 …35.888-80 80 35.888 80 80 80 80-35.888 80-80z"fill="%23fff"/%3E%3C/svg%3E) center center no-repeat;
}
```
