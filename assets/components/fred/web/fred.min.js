...
tag_limit:e.limit||0,field_type:"tagger-field-tags",hide_input:e.hideInput||!1,show_autotag:e.autoTag||!1,allow_new:!1,as_radio:!1,tags:i},A,function(t){n(e.name,t.join(","),a,e,o)}),a=o.render();r.replaceWith(a)}).catch(function(e){v.default.emit("fred-loading",e.message)}),r};t.default={text:F,select:U,toggle:_,area:H,dateTime:S,colorSwatch:T,colorPicker:x,slider:k,page:I,image:L,file:N,folder:O,choices:D,tagger:M}},function(e,t,n){/* flatpickr v4.5.2, @license MIT */
