...
function X(e){return e+"%"}function V(e,t,r,i,A,o){return ce.length>1&&(i&&t>0&&(r=Math.max(r,e[t-1]+n.margin)),A&&t<ce.length-1&&(r=Math.min(r,e[t+1]-n.margin))),ce.length>1&&n.limit&&(i&&t>0&&(r=Math.min(r,e[t-1]+n.limit)),A&&t<ce.length-1&&(r=Math.max(r,e[t+1]-n.limit))),n.padding&&(0===t&&(r=Math.max(r,n.padding[0])),t===ce.length-1&&(r=Math.min(r,100-n.padding[1]))),r=ye.getStep(r),r=l(r),!(r===e[t]&&!o)&&r}function G(e,t){var r=n.ort;return(r?t:e)+", "+(r?e:t)}function Y(e,t,n,r){var i=n.slice(),A=[!e,e],o=[e,!e];r=r.slice(),e&&r.reverse(),r.length>1?r.forEach(function(e,n){var r=V(i,e,i[e]+t,A[n],o[n],!1);r===!1?t=0:(t=r-i[e],i[e]=r)}):A=o=[!0];var a=!1;r.forEach(function(e,r){a=ee(e,n[e]+t,A[r],o[r])||a}),a&&r.forEach(function(e){j("update",e),j("slide",e)})}function W(e,t){return n.dir?100-e-t:e}function q(e,t){ve[e]=t,be[e]=ye.fromStepping(t);var r="translate("+G(X(W(t,0)-Ue),"0")+")";ce[e].style[n.transformRule]=r,te(e),te(e+1)}function $(){Be.forEach(function(e){var t=ve[e]>50?-1:1,n=3+(ce.length+t*e);ce[e].style.zIndex=n})}function ee(e,t,n,r){return t=V(ve,e,t,n,r,!1),t!==!1&&(q(e,t),!0)}function te(e){if(ue[e]){var t=0,r=100;0!==e&&(t=ve[e-1]),e!==ue.length-1&&(r=ve[e]);var i=r-t,A="translate("+G(X(W(t,i)),"0")+")",o="scale("+G(i/100,"1")+")";ue[e].style[n.transformRule]=A+" "+o}}/*! In this file: All methods eventually exposed in slider.noUiSlider... */
